      ...
      <div className=" 2xl:container 2xl:mx-auto font-worSans py-10">
        ...
        <div className=" flex justify-center items-center">
          <button
            ...
            className=" hover:bg-gray-700 focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 bg-gray-800 py-5 md:px-16 md:w-auto w-full lg:mt-20 md:mt-12 mt-10 text-white font-medium text-base leading-4"
          >
            {isShowAll? 'Less' : 'Load More'}
          </button>
        </div>
      </div>
    </div>
