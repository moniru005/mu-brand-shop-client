    ...
    <div>
      ...
      <div className="dark:bg-slate-900 dark:text-white">
        ...
        <div className="flex lg:flex-row flex-col max-w-6xl mx-auto font-worSans lg:gap-10 p-4">
          ...
          {/* Right side */}
          <div className="lg:w-2/6 mb-10 mt-20 bg-slate-100 rounded lg:px-10 lg:py-6 px-4 dark:bg-slate-900 dark:text-white">
            ...
            <hr className="my-6" />
            <div className="flex  justify-between items-center  text-xl font-semibold text-gray-600 dark:text-white">
              <p>Total</p>
              <p>$ {result}</p>
            </div>
          </div>
